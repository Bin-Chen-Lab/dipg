This code is used to identify repurposing hits for Diffuse Intrinsic Pontine Glioma (DIPG). It is based on the  [OCTAD](https://github.com/Bin-Chen-Lab/octad) package. 
## 
